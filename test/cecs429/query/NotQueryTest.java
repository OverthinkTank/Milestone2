...
public class NotQueryTest {
    ...
    /**
     * Test of getPostings method, of class NotQuery.
     */
    @Test
    public void testGetPostings() throws IOException {
        System.out.println("Not Query Test Case I Complete");
        ...
        String query = "word -document"; //Not query 
     ...
     @Test
        ...
        System.out.println("Not Query Test Case II Complete");
        DocumentCorpus corpus = DirectoryCorpus.loadJsonDirectory(Paths.get("C:\\Users\\dipes\\Desktop\\Unit Test\\JSON").toAbsolutePath(), ".json");
     ...
     @Test
        ...
        System.out.println("Not Query Test Case III Complete");
        DocumentCorpus corpus = DirectoryCorpus.loadJsonDirectory(Paths.get("C:\\Users\\dipes\\Desktop\\Unit Test\\JSON").toAbsolutePath(), ".json");
        String query = "word -test";
        Index[] index = indexCorpus(corpus);
        BooleanQueryParser queryparser = new BooleanQueryParser();
        QueryComponent query_component = queryparser.parseQuery(query);
        int i = 0;
